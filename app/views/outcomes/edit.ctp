...
<?php echo $this->Form->create('Outcome');?>
	<fieldset>
 		<legend><?php __('Edit Outcome'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Outcome.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Outcome.id'))); ?></li>
